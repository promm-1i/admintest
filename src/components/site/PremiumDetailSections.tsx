...
const PREMIUM_FAQ = [
  {
    q: "기본형 · 랜딩형과 무엇이 다른가요?",
    a: "기능은 같습니다. 관리자 모드 · 반응형 제작 · 데이터베이스 · 문자 알림은 64만 원 기본형에도 그대로 들어갑니다. 다른 것은 완성된 화면을 고르시는지, 브랜드에 맞춰 짓는지입니다. 기본형과 랜딩형은 만들어 둔 화면에 문구 · 사진만 바꿔 엽니다. 프리미엄은 섹션 순서와 개수를 사장님 사업에 맞춰 다시 잡고, 브랜드 색 · 글꼴을 바꾸고, 사진을 새로 만듭니다. 관리자도 다루실 데이터에 맞춰 설계해 조건 검색과 직원별 권한까지 넣습니다. 유지보수 월 3회와 예약 접수 관리도 프리미엄에만 들어갑니다.",
  },
  {
  ...
  },
  {
    ...
    a: "공지 · 문의 · 팝업은 관리자 화면에서 직접 수정하십니다. 디자인을 바꾸는 수정은 오픈 후 1개월 동안 무상이고, 이후에는 건별로 처리합니다.",
  },
];
