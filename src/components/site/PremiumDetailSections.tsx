...
const PREMIUM_FAQ = [
  ...
  {
    q: "제작 기간은 얼마나 걸리나요?",
    a: "자료를 받은 뒤 영업일 기준 10일 이내에 완성합니다. 사진 제작과 검수까지 이 기간 안에 들어갑니다.",
  },
  {
    q: "오픈한 다음 내용은 어떻게 고치나요?",
    a: "공지 · 문의 · 팝업은 관리자 화면에서 직접 수정하십니다. 디자인을 바꾸는 수정은 오픈 후 1개월 동안 무상입니다. 그 뒤에는 월 3만원 유지보수 계약(간단 수정 월 3회)을 하시거나, 계약 없이 건별로 비용을 협의해 진행합니다.",
  },
];
