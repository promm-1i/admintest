...
const BUY_FAQ = [
  {
    q: "쓸 만한 사진이 없어요.",
    a: "업종별로 준비해 둔 공용 사진 세트에서 골라 넣어 드립니다. 매장 · 제품 사진을 주시면 그것을 우선 쓰고, 없어도 제작에는 문제가 없습니다. 브랜드에 맞춰 사진을 새로 제작하는 것은 프리미엄 라인에서 해 드립니다.",
  },
  {
  ...
  },
  {
    ...
    a: "이 화면의 색과 섹션 구성은 그대로 두고, 문구 · 사진 · 상호 · 연락처를 바꿔 넣습니다. 화면을 다시 짜지 않기 때문에 64만원부터 영업일 7일에 열 수 있습니다. 브랜드 색 · 글꼴을 바꾸고 섹션 순서까지 다시 잡는 것은 프리미엄 라인에서 해 드립니다.",
  },
  {
    q: "제작 후에 내용은 어떻게 고치나요?",
    a: "공지 · 게시글 · 팝업은 관리자 모드에서 직접 수정하실 수 있습니다. 디자인 수정은 오픈 후 1개월 동안 무상이고, 그 뒤에는 월 3만원 유지보수 계약(간단 수정 월 3회)이나 건별 협의로 처리합니다.",
  },
  {
    q: "매달 나가는 비용이 있나요?",
    a: "첫 해는 도메인이 제작비에 들어 있고 호스팅료는 따로 받지 않아, 따로 나가는 돈이 없습니다. 2년차부터 도메인 갱신 연 3만원이 듭니다. 유지보수 계약(월 3만원)은 원하실 때만 하시면 되고, 오픈 후 1개월은 무상입니다.",
  },
];
