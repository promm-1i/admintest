...
export const PROCESS_STEPS = [
  { step: "01", title: "상담 접수", desc: "필요한 페이지 구성과 예산, 일정을 확인합니다." },
  { step: "02", title: "자료 전달", desc: "로고, 사진, 소개 문구 등 보유하신 자료를 전달받습니다." },
  { step: "03", title: "구성안 정리", desc: "페이지 구성과 정보 배치를 담은 구성안을 먼저 안내드립니다." },
  { step: "04", title: "디자인 제작", desc: "구성안을 기반으로 실제 홈페이지를 디자인하고 개발합니다." },
  { step: "05", title: "검수 및 수정", desc: "시안을 확인하시고 필요한 부분을 수정합니다." },
  { step: "06", title: "배포 및 유지보수", desc: "실제 도메인에 배포하고, 이후 수정 요청도 대응해 드립니다." },
];
