...
const study: CaseStudy = {
  ...
  capabilities: {
    label: "290-PAGE ENTERPRISE SYSTEM",
    title: "대기업·그룹사 홈페이지의 운영 범위를 290개 화면으로 구현했습니다",
    body: "메인 디자인만 보여 주는 시안이 아니라 사업, 관계사, 투자정보, 지속가능경영, 홍보 아카이브, 채용과 영문 사이트를 실제 목록·상세 화면까지 연결했습니다. 기능군을 선택하면 각 운영 영역의 대표 화면과 포함 범위를 확인할 수 있습니다.",
    stats: [
      { value: "290", label: "실제 구축 화면", note: "국문·영문·목록·상세 포함" },
      { value: "108", label: "뉴스 화면", note: "목록 10쪽과 기사 상세 아카이브" },
      { value: "103", label: "갤러리 화면", note: "분류별 목록과 콘텐츠 상세" },
      { value: "21", label: "영문 화면", note: "그룹사·뉴스를 포함한 글로벌 구성" },
    ],
    groups: [
      {
        label: "핵심 사업 5분야",
        title: "사업별 설비와 공정, 처리 역량을 독립된 상세 화면으로 설명합니다",
        body: "그레인, 정선, 컨테이너 터미널, 항만물류와 3PL을 각각 분리하고 사업 규모, 시설, 공정과 품질관리 정보를 사진·수치와 함께 제공합니다.",
        items: ["사업 5분야 독립 상세", "설비·공정·처리 역량 시각화", "메인 고정 장면에서 사업 상세 연결"],
        img: "/cases/corporate-r/page-business-grain.webp",
        caption: "사업 영역 · 그레인터미널 상세",
        file: "business-grain.html",
      },
      {
        label: "관계사 9개",
        title: "그룹 구조와 관계사별 사업 정보를 별도 화면으로 확장합니다",
        body: "물류, 터미널, 운송, 트레이딩, 금융·투자와 지역사회 법인을 그룹 장면에서 연결하고 각 관계사의 역할과 연락 정보를 독립적으로 제공합니다.",
        items: ["관계사 9개 소개 화면", "사업 분야별 그룹 구조", "법인별 역할·연락처·사이트 연결"],
        img: "/cases/corporate-r/page-group-logistics.webp",
        caption: "그룹사 · 물류 관계사 소개",
        file: "group-logistics.html",
      },
      {
        label: "투자·공시",
        title: "재무제표와 공시·입찰 자료를 실제 운영 화면으로 제공합니다",
        body: "재무상태표와 손익계산서, 공시자료와 입찰공고를 표·목록 구조로 구성해 투자자와 협력사가 필요한 자료를 빠르게 확인하게 합니다.",
        items: ["재무상태표·손익계산서", "공시자료와 첨부파일", "입찰공고 목록·상세"],
        img: "/cases/corporate-r/page-financial-position.webp",
        caption: "투자정보 · 재무상태표",
        file: "financial-position.html",
      },
      {
        label: "뉴스·갤러리",
        title: "100건이 넘는 기업 기록을 목록과 상세 아카이브로 연결했습니다",
        body: "뉴스는 10쪽의 목록과 기사 상세로, 갤러리는 분류별 목록과 100개 이상의 콘텐츠 화면으로 구성해 오래된 자료도 계속 탐색할 수 있습니다.",
        items: ["108개 뉴스 목록·상세 화면", "103개 갤러리 목록·상세 화면", "영상·브로슈어 홍보자료 연결"],
        img: "/cases/corporate-r/page-gallery.webp",
        caption: "홍보관 · 기업 갤러리 아카이브",
        file: "gallery.html",
      },
      {
        label: "입찰·채용",
        title: "협력사와 지원자가 반복 방문하는 공고 기능을 분리했습니다",
        body: "입찰은 공고 목록과 첨부자료로, 채용은 인재상·복리후생·공고 상세로 이어져 각 방문자가 필요한 행동까지 바로 이동하게 합니다.",
        items: ["입찰공고와 개별 공고 상세", "채용공고 목록·상세", "인재상·복리후생·지원 안내"],
        img: "/cases/corporate-r/page-bids.webp",
        caption: "입찰 · 공고 목록과 상세 연결",
        file: "bids.html",
      },
      {
        label: "영문·글로벌",
        title: "영문 메인에서 관계사와 글로벌 뉴스까지 같은 구조로 제공합니다",
        body: "해외 고객과 파트너가 회사와 사업을 이해할 수 있도록 영문 메인, 관계사 9개와 글로벌 뉴스 목록·상세를 별도 화면으로 구성했습니다.",
        items: ["영문 메인과 회사·사업 소개", "영문 관계사 9개 화면", "영문 뉴스 목록·상세"],
        img: "/cases/corporate-r/page-en.webp",
        caption: "글로벌 · 영문 메인",
        file: "en.html",
      },
    ],
  ...
  points: [
    ...
    { title: "채용 정보는\n메인 맨 아래에 둡니다", body: "인재상, 복리후생, 채용 공고를 메인 맨 아래에 모아 두어 회사를 다 읽은 뒤 바로 지원 정보로 넘어갑니다.", items: ["인재상 바로가기", "복리후생 안내", "채용 공고 연결"], img: "/cases/corporate-r/point-recruit.webp", caption: "홈 · 채용" },
  ],
  details: [
