...
const study: CaseStudy = {
  ...
  capabilities: {
    ...
    groups: [
      ...
      { label: "R&D·인증", title: "연구조직과 특허·인증 자료를 기술 신뢰의 근거로 제공합니다", body: "연구소, 연구개발 성과와 인증·특허를 별도 화면으로 나눠 기술기업이 필요한 검증 자료를 분야별로 나눠 보여 줍니다.", items: ["연구소·R&D 성과 화면", "인증·특허 15장 더보기", "인증서 확대 보기"], img: "/cases/corporate-i/page-patents.webp", caption: "R&D · 인증 및 특허", file: "patents.html" },
