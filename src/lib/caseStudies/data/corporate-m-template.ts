...
const study: CaseStudy = {
  ...
  summary:
    "산업설비 기업의 기술력과 전문성을 효과적으로 전달하는 프리미엄 기업 홈페이지입니다. 회사소개, 사업영역, 인증·특허, 미디어, 채용, 자료실, 상담 문의까지 기업 홈페이지에 필요한 전체 구성을 제공합니다.",
  brandColor: "rgb(0, 112, 239)",
  tintColor: "rgb(232, 243, 255)",
  overview:
    "산업설비 기업이 보유한 기술, 설비, 수행 역량을 방문자가 쉽게 이해할 수 있도록 정보의 흐름을 설계했습니다. 회사의 전문성과 사업 경쟁력을 첫 화면부터 주요 사업영역, 성과, 인증 자료, 고객 사례 순으로 자연스럽게 확인할 수 있습니다.\n\n업종과 브랜드에 맞춰 회사명, 색상, 사진, 메뉴, 사업 내용을 변경할 수 있으며 PC·태블릿·모바일에서 편리하게 이용할 수 있도록 제작합니다. 문의 접수, 자료 등록, 소식 관리처럼 운영에 필요한 기능도 상담 후 연결할 수 있습니다.\n\nFLOVEX와 화면에 표시된 회사 정보, 실적, 고객사, 연혁은 디자인 구성을 보여주기 위한 예시입니다.",
  meta: [
    {
      label: "적합 업종",
  ...
  pages: [
    ...
    },
    {
      ...
      desc: "반도체 분야의 기술, 설비, 적용 공정을 설명과 현장 이미지로 체계적으로 소개합니다.",
    ...
    },
    {
      ...
      items: ["복리후생 제도 안내", "사내 공간과 근무 환경 소개", "채용 브랜드 이미지 강화"],
    },
    {
      name: "문의",
      file: "inquiry.html",
  ...
  points: [
    {
      title: "주요 사업영역을\n한눈에 보여줍니다",
      body: "여러 사업 분야를 직관적으로 비교할 수 있도록 구성했습니다. 각 사업영역은 상세 소개 페이지로 연결되어 기술, 설비, 적용 분야를 체계적으로 안내할 수 있습니다.",
      items: [
        "핵심 사업영역을 한눈에 확인",
        "각 분야의 상세 페이지 연결",
        "PC·모바일에 맞춘 화면 구성",
    ...
    {
      title: "기업 비전과\n기술 철학을 전달합니다",
      body: "스크롤 흐름에 따라 기업의 미션과 비전이 자연스럽게 이어집니다. 단순한 회사 소개를 넘어 방문자가 브랜드 방향성과 기술 철학을 기억하도록 구성했습니다.",
      items: [
        "기업 비전과 핵심가치 강조",
        "몰입감 있는 스크롤 전환",
        "브랜드 메시지에 맞게 변경 가능",
    ...
    {
      title: "복잡한 기술 정보도\n읽기 쉽게 구성합니다",
      body: "전문 용어가 많은 산업설비 분야도 핵심 설명과 현장 이미지를 순서대로 배치해 고객이 기술의 특징과 적용 범위를 자연스럽게 이해하도록 돕습니다.",
    ...
    {
      title: "복리후생과 조직문화로\n채용 브랜드를 강화합니다",
      body: "지원자가 복리후생, 근무 환경, 조직문화를 미리 확인할 수 있도록 구성해 회사의 인재상과 일하는 방식을 효과적으로 전달합니다.",
      items: ["복리후생 제도 안내", "사내 공간과 조직문화 소개", "채용 정보와 자연스럽게 연결"],
  ...
  mobile: {
    ...
    body: "작은 화면에서도 사업 내용과 자료를 쉽게 읽고 원하는 메뉴로 이동할 수 있도록 구성합니다. 상담 문의까지 자연스럽게 이어져 이동 중인 고객도 편리하게 이용할 수 있습니다.",
    shots: [
