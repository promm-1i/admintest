...
const study: CaseStudy = {
  ...
  pages: [
    ...
    },
    {
      ...
      desc: "대형 사업 비주얼 다음에 세 개의 설명 블록과 설비 사진 세 장이 빈 구간 없이 교차 배치됩니다.",
      items: [
        "사업 비주얼 1",
        "설명 블록 3 · 본문 사진 3",
        "1440px 높이 2,721px",
    ...
    },
    {
      ...
      desc: "데이터센터 냉각·유틸리티 사업 소개를 다섯 개의 설명 블록과 다섯 장의 설비 사진으로 구성했습니다.",
      items: [
        "사업 비주얼 1",
        "설명 블록 5 · 본문 사진 5",
        "1440px 높이 4,021px",
    ...
    },
    {
      ...
      items: [
        ...
        "복지 항목 14",
        "공간 사진 2",
        "1440px 높이 3,948px · 390px 높이 4,975px",
      ],
    },
    {
      name: "문의",
  ...
  points: [
    ...
    {
      title: "사업영역 6쪽의 빈 구간을 없애고\n본문 흐름을 다시 측정했습니다",
      body: "여섯 사업 페이지의 고정 문서 높이와 절대 위치 갤러리를 제거하고 설명과 사진이 자연스럽게 이어지는 구조로 바꿨습니다. 본문 제목 블록은 24개, 사진은 23개이며 인접 블록 간 최대 간격은 1440px에서 130px, 390px에서 72px입니다.",
      items: [
        "사업 페이지 6",
        "본문 제목 블록 24 · 사진 23",
        "1440px 블록 간격 110–130px",
        "390px 블록 간격 64–72px",
        "가로 넘침 0건",
      ],
    ...
    {
      title: "미디어센터는 카드\n11개로 구성했습니다",
      body: "미디어센터 페이지에는 검색 줄과 열한 개의 카드가 있습니다. 문서 높이는 1440px 화면에서 3,169px, 390px 화면에서 6,369px로 측정됐으며 더보기와 검색 결과 표시를 직접 확인했습니다.",
  ...
  details: [
    ...
    {
      title: "사업 상세 공백 개선",
      body: "사업영역 6쪽의 고정 문서 높이와 절대 위치 갤러리를 자연스러운 문서 흐름으로 교체했습니다. 1440 · 768 · 390px 총 18개 조합에서 가로 넘침, 깨진 이미지, 콘솔 오류가 모두 0건이며 본문 인접 블록의 최대 간격은 각 화면 폭에서 130px 이하입니다.",
    },
    {
      title: "JPG 사진 자산 18개",
    ...
    {
      title: "정적 샘플 범위",
      body: "현재 결과물은 정적 HTML 템플릿입니다. 목록 검색·더보기·필터와 데모 안내는 브라우저에서 동작하지만 문의 저장, 실제 파일 제공, 관리자 등록에는 서버나 외부 서비스 연동이 필요합니다.",
    },
  ],
  mobile: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "검색·더보기와 데모 안내는 브라우저에서 동작합니다. 문의 저장·전송, 실제 파일 제공, 관리자 등록에는 서버나 외부 서비스 연동이 필요합니다.",
    },
    {
      q: "사진 자산은 몇 장인가요?",
