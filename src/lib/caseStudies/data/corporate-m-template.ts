...
const study: CaseStudy = {
  ...
  points: [
    ...
    {
      title: "미디어센터는 카드\n11개로 구성했습니다",
      body: "미디어센터 페이지에는 검색 줄과 열한 개의 카드가 있습니다. 문서 높이는 1440px 화면에서 3,169px, 390px 화면에서 6,369px로 측정됐습니다.",
  ...
  details: [
    ...
    {
      title: "영문 중심 데모",
      body: "현재 26개 HTML 중 23개에는 한글 문자가 없으며, 화면 문구는 영문 중심입니다. 한국어 기업 홈페이지로 납품하려면 메뉴와 본문 카피를 별도로 교체해야 합니다.",
    },
    {
      title: "정적 샘플 범위",
  ...
  faq: [
    ...
    {
      q: "현재 데모가 모두 한글인가요?",
      a: "아닙니다. 현재 화면 문구는 영문 중심이며 26개 HTML 중 23개에는 한글 문자가 없습니다. 한국어 문구 교체는 별도 작업 범위입니다.",
    },
    {
