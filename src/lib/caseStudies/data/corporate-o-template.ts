...
const study: CaseStudy = {
  ...
  capabilities: {
    ...
    groups: [
      ...
      { label: "연구기술", title: "원료 발굴부터 추출·분석·제품화까지 연구 과정을 공개합니다", body: "기술 설명과 보유 장비, 연구 과정을 단계별로 나눠, 앞쪽의 원료 사진을 확인 가능한 자료로 받칩니다.", items: ["R&D 프로세스", "보유 기술과 연구 장비", "특허·인증 자료 연결"], img: "/cases/corporate-o/page-technology.webp", caption: "R&D · 연구기술", file: "technology.html" },
  ...
  points: [
    ...
    { title: "거점 정보와 원료 문의를\n한 구간에서 연결합니다", body: "국내외 회사 위치와 연락처를 확인한 뒤 필요한 원료와 수량을 문의할 수 있도록 마지막 화면을 단순하게 정리합니다.", items: ["국내외 거점 정보", "연락처와 지도", "원료·샘플 문의 연결"], img: "/cases/corporate-o/point-contact.webp", caption: "홈 · 위치와 문의" },
  ],
  details: [
