...
const study: CaseStudy = {
  ...
  pagesTitle: "전체 화면",
  pages: [
    { name: "홈", file: "index.html", img: "/cases/corporate-t/page-index.webp", desc: "하는 일과 참여국을 먼저 알리고 미션·콘텐츠·숫자·인증제도·소식 순으로 내려갑니다.", items: ["배경 영상 자리 히어로", "참여국 흐름 띠", "성과 숫자 장면", "인증제도 카드 다섯"] },
  ...
  points: [
    { title: "하는 일을\n첫 화면에서 바로 알립니다", body: "배경 영상 자리 위에 한 문장을 크게 놓고, 바로 아래 참여국 띠를 흘려 어디와 일하는 기관인지 스크롤 전에 알 수 있게 했습니다.", items: ["대형 히어로 문장", "참여국 흐름 띠", "교육과정 보기 버튼"], img: "/cases/corporate-t/point-mission.webp", caption: "홈 · 첫 화면" },
