...
const FAQS: FaqItem[] = [
  {
    ...
    a: "템플릿 라인은 영업일 7일부터 보시면 됩니다. 서브페이지를 넣어도 같습니다. 프리미엄 라인은 사진 제작과 검수까지 포함해 영업일 10일 이내입니다.",
  },
  {
    category: "제작 문의",
  ...
  {
    category: "제작 문의",
    q: "템플릿 라인과 프리미엄 라인은 무엇이 다른가요?",
    a: "기능은 같습니다. 관리자 모드 · 반응형 · 데이터베이스 · 문자 알림은 64만원 기본형에도 그대로 들어갑니다. 다른 것은 완성된 화면을 고르시는지, 브랜드에 맞춰 짓는지입니다. 템플릿 라인은 만들어 둔 화면에 문구 · 사진만 바꿔 열고, 프리미엄 라인은 섹션 구성과 브랜드 색 · 글꼴을 다시 잡고 사진을 새로 제작합니다.",
  },
  ...
  },
  {
    ...
    a: "기본 관리자 모드는 무료로 제공됩니다. 업종별 맞춤 관리자 시스템은 별도 상담 후 견적을 안내드립니다.",
  },
...

  {
    category: "유지보수",
    q: "제작 완료 후 수정이 가능한가요?",
    a: "네. 오픈 후 1개월 동안은 무상으로 수정해 드립니다. 그 뒤에는 월 3만원 유지보수 계약(간단 수정 월 3회)을 하시거나, 계약 없이 건별로 비용을 협의해 진행합니다.",
  ...
  { category: "관리자 · 기능", q: "회원가입과 로그인 기능도 가능한가요?", a: "네, 회원 기능은 확장 기능으로 추가할 수 있습니다. 기본 제공 항목이 아니라 범위에 따라 상담 후 견적을 안내드립니다." },
