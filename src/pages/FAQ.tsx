...
const FAQS: FaqItem[] = [
  ...
  { category: "도메인 · 운영", q: "도메인은 누가 소유하나요?", a: "도메인은 고객님 명의로 등록하는 것을 권장하며, MintCL은 연결과 관리를 지원합니다." },
  { category: "도메인 · 운영", q: "기존 도메인을 사용할 수 있나요?", a: "네, 보유하신 도메인이 있다면 그대로 연결해 사용할 수 있습니다." },
  { category: "도메인 · 운영", q: "호스팅은 무엇인가요?", a: "홈페이지가 인터넷에서 24시간 운영되는 서버 공간입니다. MintCL이 대행해서 안내드립니다." },
];
...
export default function FAQ() {
  usePageTitle(
    "고객센터 — MintCL",
    "제작 문의, 비용, 유지보수, 관리자 기능, 도메인까지 MintCL 홈페이지 제작에 대해 자주 묻는 질문을 안내합니다.",
  );
