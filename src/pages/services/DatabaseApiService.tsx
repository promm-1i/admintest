      ...
      <div className="py-14 sm:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-4">
            ...
            <Reveal delay={120} className="w-full sm:w-48">
            ...
            <ArrowRight className="h-5 w-5 shrink-0 rotate-90 text-primary sm:rotate-0" />
            <Reveal delay={240} className="w-full sm:w-48">
              <div className="rounded-lg border border-border bg-card px-5 py-4 text-center">
          ...
          <Reveal delay={300} className="mx-auto mt-10 max-w-xl rounded-lg border border-border bg-card p-5">
