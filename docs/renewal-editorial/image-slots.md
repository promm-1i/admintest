...
프롬프트 문서는 `Desktop\개발\리뉴얼시안_이미지13장_요청.md` 에 있다. 슬롯 이름은 9개지만 실제 파일은 13장이다.

| 슬롯 | 파일 수 | 표시 크기 | 자르기 |
|---|---:|---|---|
| `hero` | 1 | 1440×791 | 영상 포스터, 전체 덮음 |
| `intro` | 1 | 160×160 | 정사각 |
| `stories` | 3 | 823×443 | 16:9 |
| `now` | 1 | 1440×900 | CSS 배경, .25배에서 확대 |
| `values` | 3 | 372×463 | 4:5, 라운드 20 |
| `tomorrow` | 3 | 425×408 / 213×408 / 213×408 | 첫 칸만 넓다 |
| `subpage` | 1 | 1120×540 | 라운드 40, 어두운 막 위 흰 제목 |

모든 자리가 `object-fit: cover`, `object-position: 50% 0%` 라 위쪽 기준으로 잘린다.
